...
function cpotheme_init_sidebar(){
    ...
    register_sidebar(array('name' => __('Default Widgets', 'illustrious'),
    'id' => 'primary-widgets',
    'description' => __('Sidebar shown in all standard pages by default.', 'illustrious'),
	...
	for($count = 1; $count <= $footer_columns; $count++){
		...
		'name' => __('Footer Widgets', 'illustrious').' '.$count,
		'description' => __('Shown in the footer area.', 'illustrious'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="widget-title heading">',
		'after_title' => '</div>'));
...
function cpotheme_init_menu(){
	...
	'top_menu' => __('Top Menu', 'illustrious'),
    'main_menu' => __('Main Menu', 'illustrious'),
    'footer_menu' => __('Footer Menu', 'illustrious')
	));
}