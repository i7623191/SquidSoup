...
if(!function_exists('cpotheme_metadata_layoutstyle')){
	function cpotheme_metadata_layoutstyle(){
		$data = array(
		'fixed' => __('Full Width', 'illustrious'),
		'boxed' => __('Boxed', 'illustrious'));
		return $data;
	}
}
...
function cpotheme_metadata_featured_page(){
	$data = array(
	'none' => __('None', 'illustrious'),
	'slider' => __('In The Slider', 'illustrious'),
	'features' => __('In The Featured Boxes', 'illustrious'));
